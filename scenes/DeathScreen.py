...
class DeathScreen:     
    def __init__(self, game):        
       self.game = game      
       self.StartButton = Button.Button(self.game.width/2 - 100, self.game.height/2 - 38,200, 76, colors.GREEN, "Start", (0, 0, 0))        
       self.QuitButton = Button.Button(self.game.width/2 - 75, self.game.height/2 + 50,150, 50, colors.RED, "Quit", (0, 0, 0))      
